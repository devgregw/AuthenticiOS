...
class ACEventPlaceholder: ACEvent {
    ...
    init(id: String, index: Int, title: String, hideTitle: Bool, header: ACImageResource, elements: [ACElement]?, action: ACButtonAction?) {
